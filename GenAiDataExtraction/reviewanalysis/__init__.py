...
REVIEWS_PATH = "/data/analytics/demand-forecasting/reviews"
    
CUT_OFF_DATE = datetime.date(2023, 9, 30)
CURRENT_REVIEWS_XLSX = "Ratings and Reviews2.xlsx"
SELECTED_STYLES = [12892, 12395, 12889, 16650, 12563, 13108]
SELECTED_STYLES_STR = [str(s) for s in SELECTED_STYLES]
